...
public class StartupConfig {
    ...
    public void bootConfiguration() {
        ...
        DataContainer arrayDataContainer = dataContainerRepository.findByIdentifier("test-container");
        if (arrayDataContainer == null) {
            arrayDataContainer = new DataContainer("test-container", "containing objects");
